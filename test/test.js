...
it('Waits on start delay', function(done) {
    ...
    tween.setUpdateTime(25).setStartDelay(400).setEndDelay(0).setCycleDelay(0).setRepeatDelay(0)
...
it('Waits on end delay', function(done) {
    ...
    tween.setUpdateTime(25).setStartDelay(0).setEndDelay(400).setCycleDelay(0).setRepeatDelay(0)
    .setRepeat(1).setCycle(false).onStart((values) => {
        events.push('start');
    }).onCycle((values) => {
        events.push('cycle');
...
it('Waits on cycle delay', function(done) {
    ...
    tween.setUpdateTime(25).setStartDelay(0).setEndDelay(0).setCycleDelay(400).setRepeatDelay(0)
...
it('Waits on repeat delay', function(done) {
    ...
    tween.setUpdateTime(25).setStartDelay(0).setEndDelay(0).setCycleDelay(0).setRepeatDelay(400)
    .setRepeat(2).setCycle(false).onStart((values) => {
        events.push('start');
    }).onCycle((values) => {
        events.push('cycle');
    }).onUpdate((values) => {
